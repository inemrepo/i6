...
var variables = { TEST1: 'MR4', 		// Memory real at MD4
		  ...
		  TEST4: 'DB10,REAL0.20',	// Array of 20 values in DB1
		  TEST5: 'DB10,REAL4',		// Single real value
		  TEST6: 'DB10,REAL8',		// Another single real value
		  TEST7: 'DB10,INT12.2'		// Two integer value array
};	
